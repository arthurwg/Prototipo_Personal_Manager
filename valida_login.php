...
if (!(empty($email) OR empty($senha))) // testa se os campos do formulário não estão vazios
{
	...
	header("Location:HOME.php"); // direciona para o cadastro de usuarios
	}
	else
	{
...
{
	$_SESSION["msg"]="<h4><p style='color:red'>Preencha os campos email e senha</h4>"; // caso contrário, ou seja, os campos do formulário email e senha estejam vazios, a mensagem é armazenada na variável msg
